...
Веса предобученных стилей можно скачать по [ссылке](https://huggingface.co/houlden/stylegan-nada/tree/main/pretrained_weights).

## Загрузка весов предобученных моделей

Загружать веса вручную нет необходимости, при первом выполнении соответствующие скрипты их сами загрузят, но ссылки на используемые веса все-таки даны ниже.
